...
export default function LecturerRegister() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("Attempting lecturer registration with:", formData.email);
      ...
      setSuccess("Lecturer account created successfully! Please check your email for verification.");
      setIsLoading(false);
      
      // Redirect to lecturer login after a short delay
      setTimeout(() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Lecturer Registration</p>
        </div>
