...
import { ClipboardCheck, Search, Filter, Plus, Edit, Trash2, Eye, Users, Loader2 } from "lucide-react"
      ...
      if (exams) {
        const transformedExams: Exam[] = exams.map((exam) => {
          ...
          return {
            ...
            date: exam.exam_date ? new Date(exam.exam_date).toISOString().split('T')[0] : "TBD",
        ...
        const uniqueCourses = Array.from(new Set(transformedExams.map(exam => exam.course)))
    ...
    <div className="flex flex-1 flex-col gap-6 p-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button onClick={handleCreateExam} className="bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 text-white">
