import { HelpCircle, MessageSquare, FileText, Phone, Mail, Search, ExternalLink } from "lucide-react"
    ...
    <div className="flex flex-1 flex-col gap-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Get assistance with your academic journey</p>
        </div>
        ...
        <Card className="lg:col-span-2 bg-white/80 backdrop-blur-sm border-blue-100 shadow-lg">
          ...
          <CardContent className="space-y-4">
            {faqData.map((faq, index) => (
              <div key={index} className="p-4 rounded-lg border border-gray-200 hover:bg-blue-50 transition-colors">
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <Button key={index} variant="outline" className="h-auto p-4 justify-start text-left hover:bg-blue-50">
                <div className="space-y-1">
