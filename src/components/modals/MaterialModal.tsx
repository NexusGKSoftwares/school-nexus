...
export default function MaterialModal({ isOpen, onClose, onSave, material, courses, mode }: MaterialModalProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button type="submit" disabled={isUploading}>
              {isUploading ? "Saving..." : mode === "create" ? "Upload" : "Save Changes"}
            </Button>
          </div>
        </form>
      </DialogContent>
