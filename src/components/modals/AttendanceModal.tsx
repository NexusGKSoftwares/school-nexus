    ...
    if (attendance) {
      setFormData({
        ...
        session_date: attendance.session_date
          ? new Date(attendance.session_date)
          : new Date(),
      });
    } else {
      setFormData({
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="late" className="text-yellow-600">
                    Late
                  </SelectItem>
                  <SelectItem value="excused" className="text-blue-600">
                    Excused
                  </SelectItem>
                  <SelectItem value="tardy" className="text-orange-600">
                    Tardy
                  </SelectItem>
                </SelectContent>
              </Select>
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  {formData.session_date
                    ? format(formData.session_date, "MMM dd, yyyy")
                    : "Not set"}
                </p>
              </div>
              <div>
                ...
                <p
                  className={cn("font-medium", getStatusColor(formData.status))}
                >
