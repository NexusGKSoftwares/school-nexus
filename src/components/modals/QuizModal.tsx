          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleInputChange('attempts_allowed', parseInt(e.target.value) || 0)}
                className={cn(errors.attempts_allowed && 'border-red-500')}
              />
              {errors.attempts_allowed && (
                <p className="text-sm text-red-500">{errors.attempts_allowed}</p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => handleInputChange('is_randomized', e.target.checked)}
                className="rounded"
              />
