...
export default function StudentRegister() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("Attempting student registration with:", formData.email);
      ...
      setSuccess("Student account created successfully! Please check your email for verification.");
      setIsLoading(false);
